      ...
      <Modal
            ...
            >
                <div className='containersupermodal'>
                    <button onClick={closeModalPlatform} className='cardbutton'>Website</button>
                    <button onClick={closeModalPlatform} className='cardbutton'>Android</button>
                    <button onClick={closeModalPlatform} className='cardbutton'>IOS</button>
                </div>
            </Modal>
